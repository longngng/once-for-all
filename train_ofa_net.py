...
from ofa.imagenet_classification.run_manager.run_config import ECGRunConfig
...
if __name__ == "__main__":
    wandb_run = wandb.init(
        project="ecg-tinyml", entity="longngng", group="OFA Training"
    )
    ...
    run_config = ECGRunConfig(**args.__dict__)
    ...
    # Just a normal run manager, not distributed. Name remains because of legacy
    distributed_run_manager = RunManager(args.path, net, run_config, no_gpu=True)
    ...
    if args.task == "kernel":
        ...
        if args.phase == 1:
            ...
            args.ofa_checkpoint_path = (
                "exp/kernel2kernel_depth/phase1/checkpoint/checkpoint.pth.tar"
            )
        ...
        if args.phase == 1:
            args.ofa_checkpoint_path = (
                "exp/kernel2kernel_depth/phase2/checkpoint/checkpoint.pth.tar"
            )
        else:
            args.ofa_checkpoint_path = "exp/kernel_depth2kernel_depth_width/phase1/checkpoint/checkpoint.pth.tar"
